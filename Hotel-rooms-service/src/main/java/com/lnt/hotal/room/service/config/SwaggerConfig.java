package com.lnt.hotal.room.service.config;
...
import com.lnt.hotal.room.service.constants.ApplicationConstants;
...
public class SwaggerConfig {
	...
	public Docket exampleRESTApi10() {
		...
		return new Docket(DocumentationType.SWAGGER_2).groupName("Hotal Room " + appName + " API V1.0")
