package com.lnt.hotal.reservation.service.config;
...
import com.lnt.hotal.reservation.service.constants.ApplicationConstants;
...
public class SwaggerConfig {
	...
	public Docket exampleRESTApi10() {
		...
		return new Docket(DocumentationType.SWAGGER_2).groupName("Hotal Reservation " + appName + " API V1.0")
				.apiInfo(ApiInfo.DEFAULT).globalOperationParameters(list).enable(true).select()
				.apis(RequestHandlerSelectors.basePackage(ApplicationConstants.BASE_PACKAGE)).paths(regex("/api/hrs/.*"))
